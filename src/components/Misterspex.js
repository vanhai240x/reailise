...
import misterpspexbanner1 from '../assets/images/misterspex-banner1.png'
import misterpspexbanner2 from '../assets/images/misterspex-banner2.png'
import misterpspexbanner3 from '../assets/images/misterspex-banner3.png'
import misterspexmobile1 from '../assets/images/misterspex-mobile1.png'
import misterspexmobile2 from '../assets/images/misterspex-mobile2.png'
import misterspexmobile3 from '../assets/images/misterspex-mobile3.png'
import misterspexlogo from '../assets/images/misterspex-logo.svg'
    ...
    return (
        <div className='innerbg' ref={innermain}>
                    ...
                    <div className="detailsInnerHero__moreInfo">
                        ...
                        <div className="detailsInnerHero__moreInfo--text right_col">
                            <p className='split-text' data-splitting>
                                Mixterspex, the biggest online glasses retailer in Germany needed a modern re-design of
                                their website.
                            </p>
                        </div>
                    </div>
            ...
            <div className="projectBanner">
                <div className="container">
                    <img className="img-slide" src={misterpspexbanner1} alt="" />
                </div>
            </div>
                    ...
                    <div className="detailsExplained__content">
                        ...
                        <div className="detailsExplained__text right_col">
                            <h2 className='split-text' data-splitting>
                                Pixel perfect, shopping platform for the best glasses you can buy.
                            </h2>
                            <p className='split-text' data-splitting>
                                The large ecommerce website features many different parts – some of which are more complex
                                than others. This is why we designed this website in components which can be easily
                                interchanegd.
                            </p>
                        </div>
                    </div>
            ...
            <div className="detailsBlock">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={misterpspexbanner2} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            The website utilises the large, beautiful imagery that Misterspex has. Full width, glossy photos
                            give this website a more luxury, attractive feel.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsLogo">
                <div className="container">
                    <div className="detailsLogo__wrapper right_col">
                        <img className="img-slide" src={misterspexlogo} alt="" />
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="mobileScreen__wrapper">
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={misterspexmobile1} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={misterspexmobile2} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={misterspexmobile3} alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsBlock bottomMargin">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={misterpspexbanner3} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            Simple rounded corners, and light UI interaction buttons help the user to remain focused on the
                            glasses and the shopping at hand, yet whilst remaining a nice, fresh and friendly feel.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="innerNav">
                <div className="container">
                    <div className="innerNav__wrapper">
                        <Link to='/kenjo' className="link" data-title="previous project">
                        ...
                        <Link to='/neom' className="link" data-title="next project">
                            next project
                            <svg width="15" height="28" viewBox="0 0 15 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
