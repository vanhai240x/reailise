...
import neombanner1 from '../assets/images/neom-banner1.png'
import neombanner2 from '../assets/images/neom-banner2.png'
import neombanner3 from '../assets/images/neom-banner3.png'
import neommobile1 from '../assets/images/neom-mobile1.png'
import neommobile2 from '../assets/images/neom-mobile2.png'
import neommobile3 from '../assets/images/neom-mobile3.png'
import neomlogo from '../assets/images/neom-logo.png'
    ...
    return (
        <div className='innerbg' ref={innermain}>
                    ...
                    <div className="detailsInnerHero__moreInfo">
                        ...
                        <div className="detailsInnerHero__moreInfo--text right_col">
                            <p className='split-text' data-splitting>
                                Neom are building the worlds first and most futuristic smart city. We designed their UI & UX
                                design system, to ensure it’s as future proof as their new city.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="projectBanner">
                <div className="container">
                    <img className="img-slide" src={neombanner1} alt="" />
                </div>
            </div>
                    ...
                    <div className="detailsExplained__content">
                        ...
                        <div className="detailsExplained__text right_col">
                            <h2 className='split-text' data-splitting>
                                The ideal UI system to build the best digital experiences possible.
                            </h2>
                            <p className='split-text' data-splitting>
                                It was a challenge to pre-determine every single component that we think Neom would need
                                ahead of any digital product they build in the future. We had to think of all capabilities
                                they would need. From over ten different types and sizes of buttons, to an icon library, a
                                specified bootstrapped grid system, colour styles and more.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="detailsBlock">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={neombanner2} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            One of the most intricate product pages we have ever worked on. An intelligent sticky side nav
                            enables the user to navigate all the parts.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsLogo">
                <div className="container">
                    <div className="detailsLogo__wrapper right_col">
                        <img className="img-slide" src={neomlogo} alt="" />
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="mobileScreen__wrapper">
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={neommobile1} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={neommobile2} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={neommobile3} alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsBlock bottomMargin">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={neombanner3} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            We designed many different versions of the navigation across both desktop and mobile to ensure
                            that all the features were covered and shown in multiples fascets.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="innerNav">
                <div className="container">
                    <div className="innerNav__wrapper">
                        <Link to='/misterspex' className="link" data-title="previous project">
                        ...
                        <Link to='/mineiros' className="link" data-title="next project">
                            next project
                            <svg width="15" height="28" viewBox="0 0 15 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
