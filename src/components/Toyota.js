...
import toyotabanner1 from '../assets/images/toyota-banner1.png'
import toyotabanner2 from '../assets/images/toyota-banner2.png'
import toyotabanner3 from '../assets/images/toyota-banner3.png'
import toyotamobile1 from '../assets/images/toyota-mobile1.png'
import toyotamobile2 from '../assets/images/toyota-mobile2.png'
import toyotamobile3 from '../assets/images/toyota-mobile3.png'
    ...
    return (
        <div className='innerbg' ref={innermain}>
                    ...
                    <div className="detailsInnerHero__moreInfo">
                        ...
                        <div className="detailsInnerHero__moreInfo--text right_col">
                            <p className='split-text' data-splitting>
                                Toyota wanted to build a complex car configurator with endless capabilities. It was our task
                                to make it feel as innovative, beautiful and ground breaking as possible.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="projectBanner">
                <div className="container">
                    <img className="img-slide" src={toyotabanner1} alt="" />
                </div>
            </div>
                    ...
                    <div className="detailsExplained__content">
                        ...
                        <div className="detailsExplained__text right_col">
                            <h2 className='split-text' data-splitting>
                                Making a complicated choice seem easy. A pioneer in its space.
                            </h2>
                            <p className='split-text' data-splitting>
                                The dynamic bold colour pallette not only enhances the look of the car, yet it gives each
                                model it’s own unique space in the digital showroom. The modular design here makes it easy
                                to view multiple cars at once in an easy way, and it’s also extremely responsive to other
                                screen sizes.
                            </p>
                        </div>
                    </div>
            ...
            <div className="detailsBlock">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={toyotabanner2} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            The navigation was a challenge as there are so many configurable parts to this website. And so
                            we developed an intelligent three tier navigation system including one in page side nav to allow
                            the users to navigate the page in a quick and easy manner.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsLogo">
                <div className="container">
                    <div className="detailsLogo__wrapper right_col">
                        <img className="img-slide" src={toyotalogo} alt="" />
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="mobileScreen__wrapper">
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={toyotamobile1} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={toyotamobile2} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={toyotamobile3} alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsBlock bottomMargin">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={toyotabanner3} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            Encorporating large, beautiful imagery of the cars in a dynamic way – helps keep the page
                            feeling engaging and full of movement. Here, the image above shows the photos in an
            ...
            <div className="innerNav">
                <div className="container">
                    <div className="innerNav__wrapper">
                        <Link to='/gea' className="link" data-title="previous project">
                        ...
                        <Link to='/kenjo' className="link" data-title="next project">
                            next project
                            <svg width="15" height="28" viewBox="0 0 15 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
