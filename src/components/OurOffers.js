...
const OurOffers = () => {
    ...
    return (
        <div className="ouroffers" ref={main}>
            ...
            <div className="ouroffers__row mhidden" >
                <div className="ouroffers__card">
                    <span className="border">
                        <svg width="433" height="485" preserveAspectRatio='none' viewBox="0 0 433 485" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="0.5" width="432" height="484" rx="49.5" fill="#22201E" fill-opacity="0.3" stroke="url(#paint0_linear_903_20137)" />
                            <defs>
                                <linearGradient id="paint0_linear_903_20137" x1="142.961" y1="-19.9798" x2="259.922" y2="585.967" gradientUnits="userSpaceOnUse">
            ...
            <div className="ouroffers__mobile">
                <h4 className='ouroffers__mobile--title'>
                    our offer
                </h4>
                <Swiper
                    modules={[Pagination]}
