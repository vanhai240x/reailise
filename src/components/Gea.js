...
import geabanner1 from '../assets/images/gea-banner1.png'
import geabanner2 from '../assets/images/gea-banner2.png'
import geabanner3 from '../assets/images/gea-banner3.png'
import geamobile1 from '../assets/images/gea-mobile-banner1.png'
import geamobile2 from '../assets/images/gea-mobile-banner2.png'
import geamobile3 from '../assets/images/gea-mobile-banner3.png'
import gealogo from '../assets/images/gea-logo.svg'
    ...
    return (
        <div className='innerbg' ref={innermain}>
                    ...
                    <div className="detailsInnerHero__moreInfo">
                        ...
                        <div className="detailsInnerHero__moreInfo--text right_col">
                            <p className='split-text' data-splitting>
                                Engineering pioneers GEA needed a refresh of their brand and website. It now features a
                                modern, heroic new look with the all new signiture brand blue – connotating feelings of
                                strength, trust, reliability and calmness.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="projectBanner">
                <div className="container">
                    <img className="img-slide" src={geabanner1} alt="" />
                </div>
            </div>
                    ...
                    <div className="detailsExplained__content">
                        ...
                        <div className="detailsExplained__text right_col">
                            <h2 className='split-text' data-splitting>
                                Initiating a trusted look connotating corporate transparency.
                            </h2>
                            <p className='split-text' data-splitting>
                                The GEA website features a minimal colour pallette, with just one bold primary colour. Greys
                                and lots of white space give a fresh and open feeling to the website.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="detailsBlock">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={geabanner2} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            We designed this in blocks of components, so that it can be maintained easily and is realistic
                            for a long-living website. The modules feature different capabilities which allow GEA to be
                            flexible enough to update the website themselves.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsLogo">
                <div className="container">
                    <div className="detailsLogo__wrapper right_col">
                        <img className="img-slide" src={gealogo} alt="" />
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="mobileScreen__wrapper">
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={geamobile1} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={geamobile2} alt="" />
                        </div>
                        <div className="mobileScreen__wrapper--item">
                            <img className="img-slide" src={geamobile3} alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="detailsBlock bottomMargin">
                <div className="container">
                    <div className="detailsBlock__banner">
                        <img className="img-slide" src={geabanner3} alt="" />
                    </div>
                    <div className="detailsBlock__text right_col">
                        <p className='split-text' data-splitting>
                            The new look is slick and state of the art. The feature font is geometic and compliments the
                            modular, square layout as it is contrasting.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="innerNav">
                <div className="container">
                    <div className="innerNav__wrapper">
                        <Link to='/theorem' className="link" data-title="previous project">
                        ...
                        <Link to='/toyota' className="link" data-title="next project">
                            next project
                            <svg width="15" height="28" viewBox="0 0 15 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
